    ...
    try:
        while True:
            ...
            if ch == 1:
                ...
                typee = True
                while typee == True:
                    Vtype = str(input("\tEnter vehicle type(Bus=A/Bike=B/Car=C):")).lower()
                    if Vtype == "":
                        print("###### Enter Vehicle Type ######")
                    elif Vtype == "a":
                        Vehicle_Type.append("Bus")
                        bus -= 1
                        typee = not True
                    elif Vtype == "b":
                ...
                print("----------------------------------------------------------------------------------------------------------------------")
                print("\tSpaces Available for Bus- ",bus)
                ...
                while inp==True:
                    ...
                    elif int(hr)==0 and Vehicle_Type[i]=="Bus":
                        amt=20
                        inp=not True
